...
type AuthClient interface {
	...
	IsAdmin(ctx context.Context, in *IsAdminRequest, opts ...grpc.CallOption) (*IsAdminResplonce, error)
}
...
func (c *authClient) IsAdmin(ctx context.Context, in *IsAdminRequest, opts ...grpc.CallOption) (*IsAdminResplonce, error) {
	out := new(IsAdminResplonce)
...
type AuthServer interface {
	...
	IsAdmin(context.Context, *IsAdminRequest) (*IsAdminResplonce, error)
...
func (UnimplementedAuthServer) IsAdmin(context.Context, *IsAdminRequest) (*IsAdminResplonce, error) {
