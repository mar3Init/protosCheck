...
func (x *IsAdminResplonce) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IsAdminResplonce) ProtoMessage() {}

func (x *IsAdminResplonce) ProtoReflect() protoreflect.Message {
	mi := &file_sso_sso_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IsAdminResplonce.ProtoReflect.Descriptor instead.
func (*IsAdminResplonce) Descriptor() ([]byte, []int) {
	return file_sso_sso_proto_rawDescGZIP(), []int{5}
}

func (x *IsAdminResplonce) GetIsAdmin() bool {
	if x != nil {
		return x.IsAdmin
	}
	return false
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x49, 0x64, 0x22, 0x2d, 0x0a, 0x10, 0x49, 0x73, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x52, 0x65, 0x73,
	0x70, 0x6c, 0x6f, 0x6e, 0x63, 0x65, 0x12, 0x19, 0x0a, 0x08, 0x69, 0x73, 0x5f, 0x61, 0x64, 0x6d,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x63, 0x65, 0x12, 0x37, 0x0a, 0x07, 0x69, 0x73, 0x41, 0x64, 0x6d,
	...
	0x49, 0x73, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6c, 0x6f, 0x6e, 0x63, 0x65,
...
var file_sso_sso_proto_goTypes = []interface{}{
	...
	(*IsAdminResplonce)(nil), // 5: auth.IsAdminResplonce
}
var file_sso_sso_proto_depIdxs = []int32{
	...
	5, // 5: auth.Auth.isAdmin:output_type -> auth.IsAdminResplonce
